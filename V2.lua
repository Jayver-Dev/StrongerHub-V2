...
ScriptsTab:CreateButton({
    ...
    Callback = function()
        ...
        if target and target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
            ...
            Rayfield:Notify({
                Title = "Kill Success",
                Content = "Target was Killed and you were teleported back.",
                Duration = 4,
                Image = "zap"
            })
        else
...
Rayfield:LoadConfiguration()local Rayfield = loadstring(game:HttpGet("https://sirius.menu/rayfield"))()
